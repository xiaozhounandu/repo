...
//    public ResponseEntity<Map<String, Object>> autoUploadAndParse() {
    public ResponseEntity<Map<String, Object>> autoUploadAndParse(@RequestParam int number) {
        Map<String, Object> result = new HashMap<>();
        String downloadUrl = "http://oa.growlib.cn/weaver/weaver.file.FileDownload?fileid="+ number +"&download=1&requestid=-1&desrequestid=-1&loginidweaver=196";
//        String downloadUrl = "http://oa.growlib.cn/weaver/weaver.file.FileDownload?fileid=44186&download=1&requestid=-1&desrequestid=-1&loginidweaver=196";
        String cookies = "JSESSIONID=aaaNWLbLx144nckVwhxFz; ecology_JSessionid=aaaNWLbLx144nckVwhxFz;"; // 替换为有效 Cookie
...
//            // 保存到本地
//            java.nio.file.Path localPath = java.nio.file.Paths.get("./downloaded_file.pdf");
//            java.nio.file.Files.copy(fileStream, localPath, java.nio.file.StandardCopyOption.REPLACE_EXISTING);
//            System.out.println("文件已保存到本地: " + localPath);
//
//            // 如果要继续上传 Dify，需要重新获取 InputStream
//            fileStream = java.nio.file.Files.newInputStream(localPath);
